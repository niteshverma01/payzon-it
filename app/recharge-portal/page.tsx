...
const services = [
    {
        ...
        description: "The recharge portal is designed with simplicity in mind, offering an intuitive interface that allows users to quickly navigate through the recharge process. Whether on a desktop or mobile device, the layout ensures an optimal experience.",
        icon: Book,
    ...
    },
    {
        ...
        description: "The portal supports a variety of payment methods, allowing users to recharge their accounts using credit/debit cards, digital wallets (like PayPal or Google Pay), bank transfer, depending on the available options.",
        icon: Lightbulb,
    ...
    },
    {
        ...
        description: "Users can complete recharge transactions in real-time, ensuring that their balance is updated immediately after payment confirmation. This quick processing minimizes delays and enhances user satisfaction.",
        icon: Shield,
    ...
    },
    {
        ...
        description: "Users can view their recharge history, including past transactions, payment amounts, and dates. This feature allows customers to track their spending and manage their account balances more effectively.",
        icon: Users,
    ...
    },
    {
        ...
        description: "Payment security is a top priority. The portal implements industry-standard encryption (SSL/TLS) to protect users’ personal and financial information. Additionally, secure authentication methods (like OTPs or 2FA) are used to ensure that only authorized users can access their accounts.",
        icon: Activity,
    ...
    },
    {
        ...
        description: "Users can opt for subscription-based recharges or set up auto-recharge functionality, ensuring that their services are always topped up at regular intervals, reducing the risk of service interruptions.",
        icon: Smartphone,
    ...
    },
    {
        ...
        description: "The recharge portal can support multiple Methods, enabling users to recharge their accounts or services regardless of their location. Currency conversion is handled automatically to ensure users pay the correct amount.",
        icon: Smartphone,
        features: ["Smart Contracts", "DApp Development", "Token Creation", "Web3 Integration"],
        gradient: "from-teal-500/20 to-blue-500/20",
    },
      {
        ...
        description: "The portal sends out notifications or alerts to users when their recharge is successful, when their balance is low, or when auto-recharge is about to occur. This helps keep users informed and in control of their recharge needs.",
        icon: Smartphone,
        features: ["Smart Contracts", "DApp Development", "Token Creation", "Web3 Integration"],
        gradient: "from-teal-500/20 to-blue-500/20",
    },
      {
        ...
        description: "The portal allows users to create and manage personal accounts, where they can save payment information, recharge preferences, and service details. This creates a more customized experience and speeds up future recharge transactions.",
        icon: Smartphone,
        features: ["Smart Contracts", "DApp Development", "Token Creation", "Web3 Integration"],
        gradient: "from-teal-500/20 to-blue-500/20",
    },
...
const features = [
    {
        icon: Focus,
        title: "Convenience",
        description: "Users can recharge anytime and from anywhere, eliminating the need to visit physical stores or wait for assistance. This 24/7 access improves customer satisfaction and retention.",
    },
    {
        icon: CircleCheck,
        title: "Time-Saving",
        description: "The portal streamlines the recharge process, reducing transaction time and providing users with a fast, hassle-free way to manage their services.",
    },
    {
        icon: User,
        title: "Security",
        description: "With robust encryption, multi-layered security features, and safe payment processing, the portal ensures that all transactions are secure and that users’ data is protected.",
    },
    {
        icon: Wallet,
        title: "Flexibility",
        description: "The portal offers multiple payment methods, service options, and currency support, catering to a wide variety of user needs, both locally and internationally.",
    },
    {
        icon: LayoutDashboard,
        title: "Improved User Engagement",
        description: "With features like auto-recharge, transaction history, and personalized accounts, the portal enhances user engagement and loyalty, encouraging repeat use.",
    },
    {
        icon: LayoutDashboard,
        title: "Business Growth",
        description: "For businesses, the recharge portal provides a new revenue stream, allowing companies to offer customers an easy way to recharge products or services, helping them expand their customer base and increase sales.",
    },
]
...
export default function Rechargeportal() {
